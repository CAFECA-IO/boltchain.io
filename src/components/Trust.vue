<template>
 ...
 height: auto;background: url(/img/2019/03/shutterstock_697695823-1.jpg) no-repeat; background-size: 100% auto; height: 100%">
    ...
    <div class="master_container" style="width: 100%;float: left;background-color: white;">
      <section class="page_content" id="section-1356">
              ...
              <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                  ...
                  <div class="wpb_text_column wpb_content_element ">
                    <div class="wpb_wrapper">
                      <p style="text-align: center; color: #adb0b8;">__</p>
                    </div>
                  </div>
                  ...
                  <div class="ult-spacer spacer-5df8d2bd70390" data-id="5df8d2bd70390" data-height="120"
              ...
              <div class="wpb_column vc_column_container col-lg-12">
                <div class="vc_column-inner ">
                  <div class="wpb_wrapper">
                    ...
                    <div class="ult-spacer spacer-5df8d2bd7092e" data-id="5df8d2bd7092e" data-height="80"
                      data-height-mobile="40" data-height-tab="" data-height-tab-portrait=""
                      data-height-mobile-landscape="40" style="clear:both;display:block;"></div>
                    <div class="vc_row wpb_row vc_inner vc_row-fluid container">
                      <div class="row">
                        <div class="wpb_column vc_column_container col-lg-4">
                          <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                              <div class="aio-icon-component    style_1 upper_icon_index-0">
                                <div id="Info-box-wrap-7174" class="aio-icon-box top-icon" style="">
                                  ...
                                  <div class="aio-icon-description ult-responsive"
                                    data-ultimate-target="#Info-box-wrap-7174 .aio-icon-description"
                        ...
                        <div class="wpb_column vc_column_container col-lg-4">
                          <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                              <div class="aio-icon-component    style_1 upper_icon_index-0">
                                <div id="Info-box-wrap-1875" class="aio-icon-box top-icon" style="">
                                  <div class="aio-icon-top">
                                    <div class="ult-just-icon-wrapper  ">
                                      <div class="align-icon" style="text-align:center;">
                                        <div class="aio-icon-img " style="font-size:80px;display:inline-block;"> <img
                                  ...
                                  <div class="aio-icon-description ult-responsive"
                                    data-ultimate-target="#Info-box-wrap-1875 .aio-icon-description"
                                    data-responsive-json-new="{font-size:desktop:16px;,line-height:}"
                                    style="color:#ffffff;">
                                    <p></p>
                        ...
                        <div class="wpb_column vc_column_container col-lg-4">
                          <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                              <div class="aio-icon-component    style_1 upper_icon_index-0">
                                <div id="Info-box-wrap-2341" class="aio-icon-box top-icon" style="">
                                  <div class="aio-icon-top">
                                    <div class="ult-just-icon-wrapper  ">
                                      <div class="align-icon" style="text-align:center;">
                                        <div class="aio-icon-img " style="font-size:80px;display:inline-block;"> <img
                                  ...
                                  <div class="aio-icon-description ult-responsive"
                                    data-ultimate-target="#Info-box-wrap-2341 .aio-icon-description"
                                    data-responsive-json-new="{font-size:desktop:16px;,line-height:}"
                                    style="color:#ffffff;">
                                    <p></p>
                                    <p style="text-align: center;">{{ $t('trust.block2.description1') }}</p>
            ...
            <div class="wpb_column vc_column_container col-lg-12">
              <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                  ...
                  <div class="wpb_text_column wpb_content_element ">
                    <div class="wpb_wrapper">
                      <p style="text-align: center; margin-top: 31px; margin-bottom: 10px;color: #adb0b8;">__</p>
                    </div>
                  </div>
                  <div class="ult-spacer spacer-5df8d2bd718c6" data-id="5df8d2bd718c6" data-height="20"
                    data-height-mobile="10" data-height-tab="" data-height-tab-portrait=""
                    data-height-mobile-landscape="10" style="clear:both;display:block;"></div>
                  <div class="text-center">
                    <figure class="wpb_wrapper vc_figure text-center">
                  ...
                  <div class="ult-spacer spacer-5df8d2bd71bc3" data-id="5df8d2bd71bc3" data-height="120"
                    data-height-mobile="40" data-height-tab="" data-height-tab-portrait=""
                    data-height-mobile-landscape="40" style="clear:both;display:block;"></div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="wpb_column vc_column_container col-lg-12">
              <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                  <div
                    class="vc_separator wpb_content_element vc_separator_align_center vc_sep_width_100 vc_sep_pos_align_center vc_separator_no_text container" style="margin-top: 120px;">
                  ...
                  <div class="wpb_text_column wpb_content_element ">
                    <div class="wpb_wrapper">
                      <p style="text-align: center; margin-top: 31px; margin-bottom: 20px;color: #adb0b8;">__</p>
                    </div>
                  </div>
                  <div class="ult-spacer spacer-5df8d2bd7219a" data-id="5df8d2bd7219a" data-height="20"
                    data-height-mobile="10" data-height-tab="" data-height-tab-portrait=""
                    data-height-mobile-landscape="10" style="clear:both;display:block;"></div>
                  <div class="text-center">
                  ...
                  <div class="ult-spacer spacer-5df8d2bd72494" data-id="5df8d2bd72494" data-height="120"
                    data-height-mobile="40" data-height-tab="" data-height-tab-portrait=""
                    data-height-mobile-landscape="40" style="clear:both;display:block;"></div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="wpb_column vc_column_container col-lg-12">
              <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                  <div
                    class="vc_separator wpb_content_element vc_separator_align_center vc_sep_width_100 vc_sep_pos_align_center vc_separator_no_text container">
                    <span class="vc_sep_holder vc_sep_holder_l"><span style="border-color:#f2f2f2;"
                        class="vc_sep_line"></span></span></div>
                  <div style="height: 72px;"></div>
